...
VkResult CStellSwapChain::acquireNextImage(uint32_t *imageIndex) {
  vkWaitForFences(
      device.device(),
      1,
...
VkResult CStellSwapChain::submitCommandBuffers(
...
void CStellSwapChain::createSwapChain() {
...
void CStellSwapChain::createImageViews() {
...
void CStellSwapChain::createRenderPass() {
...
void CStellSwapChain::createFramebuffers() {
...
void CStellSwapChain::createSyncObjects() {
...
VkPresentModeKHR CStellSwapChain::chooseSwapPresentMode(
...
VkExtent2D CStellSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat CStellSwapChain::findDepthFormat() {
