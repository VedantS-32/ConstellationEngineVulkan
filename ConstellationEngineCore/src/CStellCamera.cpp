...
namespace CStell
{
	...
	void CStellCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up)
	{
	...
	void CStellCamera::setViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up)
	{
		setViewDirection(position, target - position, up);
	}

	void CStellCamera::setViewYXZ(glm::vec3 position, glm::vec3 rotation)
	{
